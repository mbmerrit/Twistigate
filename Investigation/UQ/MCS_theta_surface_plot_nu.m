...
subplot(141);hold on;
f1=gscatter(X_5,X_1*1e3,group_idx,[],[],[],'off');
...
subplot(142);hold on;
gscatter(X_5,X_2*1e3,group_idx,[],[],[],'off');
xlabel('$\nu$','fontsize',20,'interpreter','latex');
...
subplot(143);hold on;
gscatter(X_5,X_3,group_idx,[],[],[],'off');
xlabel('$\nu$','fontsize',20,'interpreter','latex');
...
subplot(144);hold on;
f1=gscatter(X_5,X_4,group_idx,[],[],[],'off');
% for k = 1:length(f1)
%     f1(k).MarkerSize = 9;
%     if k == 1
...
% print(['figures/surface_nu_vs_parameters.fig'],'-deps','-r0','-painters')
savefig(['figures/surface_nu_vs_parameters.fig'])
